...
class RankingFormulaTest extends TestCase
{
    ...
    #[Test]
    public function testRankingFormulaCorrectlyAppliesTimeDecayAndVoteWeighting()
    {
    // Create a community
    ...
    #[Test]
    public function testRankingHandlesZeroAndNegativeScoresCorrectly()
    {
    // Create a community
        $community = Community::factory()->create();
    ...
    #[Test]
    public function testRankingHandlesSignificantTimeDecayForOldPostsCorrectly()
    {
    // Create a community
        $community = Community::factory()->create();
    ...
    #[Test]
    public function testRankingHandlesPostsWithIdenticalWeightedScores()
    {
    // Create a community
        $community = Community::factory()->create();
